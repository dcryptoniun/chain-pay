  ...
  return (
    <div className="flex flex-row items-center justify-center w-full">
      {isConnected ? (
        <div className="flex">
          <Link to="/settings">
            <div className="flex flex-col items-center justify-center h-auto gap-2 p-5 m-1 text-center bg-gradient-to-b hover:bg-gradient-to-t from-teal-600 to-fuchsia-800 rounded-2xl w-28 md:tracking-wide">
